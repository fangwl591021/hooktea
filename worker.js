    ...
    function renderProducts(){
      ...
      document.getElementById("products").innerHTML = shown.map(p => {
        ...
        return '<article class="card">'
          +(sourceUrl ? '<a class="product-link" href="'+escapeAttr(sourceUrl)+'">'+image+'</a>' : image)
          +'<div class="card-body"><span class="badge">'+escapeHtml(p.badge || "HookTea")+'</span>'
          +(sourceUrl ? '<a class="product-title" href="'+escapeAttr(sourceUrl)+'">'+title+'</a>' : title)
          ...
          +(sourceUrl ? '<a class="source-link" href="'+escapeAttr(sourceUrl)+'">查看官網商品</a>' : '')
          +'</div></article>';
